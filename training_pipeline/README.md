...
The first public detection baseline uses only object-level data sources:

- TACO: 80 images added.
- Innovatiana Garbage Detection: 120 images added from 10,464 available image/label pairs.
- Combined YOLO dataset: 160 train images and 40 validation images.
...
- `customer-scenes/bulky-waste-pile.jpg`: 2 detections
- `customer-scenes/dirty-ground-scatter.jpg`: 3 detections
- `customer-scenes/overflow-bin-row.jpg`: 1 detection
